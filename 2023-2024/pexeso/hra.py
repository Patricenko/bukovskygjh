...
level.add_command(label = f'Level 1',  command = lambda:[load(1)])
level.add_command(label = f'Level 2',  command = lambda:[load(2)])
level.add_command(label = f'Level 3',  command = lambda:[load(3)])
level.add_command(label = f'Level 4',  command = lambda:[load(4)])
level.add_command(label = f'Level 5',  command = lambda:[load(5)])
level.add_command(label = f'Level 6',  command = lambda:[load(6)])
level.add_command(label = f'Level 7',  command = lambda:[load(7)])
level.add_command(label = f'Level 8',  command = lambda:[load(8)])
level.add_command(label = f'Level 9',  command = lambda:[load(9)])
level.add_command(label = f'Level 10', command = lambda:[load(10)])
level.add_command(label = f'Level 11', command = lambda:[load(11)])
level.add_command(label = f'Level 12', command = lambda:[load(12)])
